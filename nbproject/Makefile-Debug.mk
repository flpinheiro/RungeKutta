...
${OBJECTDIR}/Gnuplot.o: Gnuplot.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gnuplot.o Gnuplot.cpp

${OBJECTDIR}/Growth.o: Growth.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Growth.o Growth.cpp

${OBJECTDIR}/GrowthCosA.o: GrowthCosA.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GrowthCosA.o GrowthCosA.cpp
...
${OBJECTDIR}/GrowthCosARand.o: GrowthCosARand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GrowthCosARand.o GrowthCosARand.cpp

${OBJECTDIR}/GrowthCosB.o: GrowthCosB.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GrowthCosB.o GrowthCosB.cpp

${OBJECTDIR}/GrowthCosBRand.o: GrowthCosBRand.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GrowthCosBRand.o GrowthCosBRand.cpp

${OBJECTDIR}/RungeKutta.o: RungeKutta.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RungeKutta.o RungeKutta.cpp
